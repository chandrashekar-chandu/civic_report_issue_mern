...
const AssignedIssues = () => {
  ...
  const fetchAssignedIssues = async () => {
    try {
      // Assumes backend returns issues assigned to the logged-in department user
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-300 text-lg">
            Review and update issues assigned to your department.
          </p>
        </div>
        ...
        {issues.length === 0 ? (
          <div className="bg-white/10 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-12 text-center">
            ...
            <p className="text-slate-300">
              There are currently no issues assigned to your
              department.
            </p>
          </div>
        ) : (
